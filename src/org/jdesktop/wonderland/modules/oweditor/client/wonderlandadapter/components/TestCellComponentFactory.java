...
public class TestCellComponentFactory implements CellComponentFactorySPI {
    ...
    public <T extends CellComponentServerState> T getDefaultCellComponentServerState() {
        TestCellComponentServerState state = new TestCellComponentServerState();
        return (T) state;
    }
